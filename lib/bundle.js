...
class Pokemon {
  ...
  draw(ctx) {
    ...
    if (!XMLHttpRequestData && !document.getElementById("charmander")) {
      var img = document.createElement("img");
      img.src = `../assets/spritesheets/006.png`;
      img.id = 'charmander'
      img.setAttribute("rel:animated_src", "https://sprites.pokecheck.org/i/004.gif");
    ...
    if (XMLHttpRequestData) {debugger}
